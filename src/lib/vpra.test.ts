...
describe("static reference lists", () => {
  it("has the 12 process areas from CLAUDE.md section 4 plus orgStructure/staffing/identity/reports (added 2026-07-22 and 2026-07-25)", () => {
    ...
    expect(processAreas).toContain("reports");
  });
