        ...
        <form onSubmit={handleSubmit} style={{ marginTop: 14 }}>
          ...
          <div className="sru-formgrid">
            ...
            <div className="sru-field">
              ...
              <input type="text" inputMode="numeric" name="startYear" required min={2000} max={2200} defaultValue={plan.startYear} />
            </div>
            <div className="sru-field">
              <label>{t("endYearLabel")}</label>
              <input type="text" inputMode="numeric" name="endYear" required min={2000} max={2200} defaultValue={plan.endYear} />
            </div>
          </div>
